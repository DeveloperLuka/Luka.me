...
{
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(0), 0, 0, 0, 0, L"Luka.me", 0 };
    RegisterClassEx(&wc);
    Window = CreateWindow(wc.lpszClassName, L"Luka.me", WS_POPUP, 0, 0, 5, 5, 0, 0, wc.hInstance, 0);
    ...
    Functions::loadSetting("main");

    CreateThread(0, 0, (LPTHREAD_START_ROUTINE)clicker::main, 0, 0, 0);
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        Menu::Theme();
        {
            ImGui::Begin("Luka.me", 0, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
            {
                Menu::Render();
            }
            ImGui::End();
